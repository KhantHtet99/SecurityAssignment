...
namespace SecurityAssignment.Areas.Identity.Pages.Account
{
    public class ForgotPasswordModel : PageModel
    {
        ...
        public ForgotPasswordModel(UserManager<ApplicationUser> userManager, IEmailSender emailSender, ApplicationDbContext db)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                await WriteAudit(user?.Id, "Reset Password Requested");
